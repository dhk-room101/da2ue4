...
const int32 SLOT_DEFAULT = 0;
const int32 SLOT_LOWER = 1;
const int32 SLOT_UPPER = 2;
const int32 SLOT_UPPER_RIGHT = 3;
const int32 SLOT_UPPER_LEFT = 4;
const int32 SLOT_HEAD = 5;

const int32 SETTING_GAME_DIFFICULTY = 1;
const int32 SETTING_GRAPHIC_DETAIL_LEVEL = 2;

const int32 TABLE_TALK = 8;
const int32 TABLE_GAME_SETTINGS = 9;
const int32 TABLE_CONVERSATION_ANIMATIONS = 10; // conversation animations
...
const int32 TABLE_ABILITIES_SPELLS = 7;
...
const int32 TABLE_COMBAT_ANIMATIONS = 4;
...
const int32 ABILITY_TALENT_FEIGN_DEATH = 3023;
const int32 ABILITY_TALENT_CAPTIVATE = 1000;
const int32 ABILITY_TALENT_PAIN = 3067;
...
//spells
//humanoids
const int32 ABILITY_SPELL_MAGE_BASE_ATTACK = 11130;
...
//TODO  class and core class in same variable?
//Class Constants
